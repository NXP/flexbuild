...
imx_codec:
	@[ $(SOCFAMILY) != IMX ] && exit || \
	 ...
	 if [ ! -d imx_codec ]; then \
		 rm -rf imx_codec*; \
	     $(WGET) $(repo_imx_codec_bin_url) -O imx_codec.bin $(LOG_MUTE); \
		 [ $$? -ne 0 ] && { echo "Downloading $(repo_imx_codec_bin_url) failed."; exit 1; } || \
	     chmod +x imx_codec.bin && ./imx_codec.bin --auto-accept --force $(LOG_MUTE); \
